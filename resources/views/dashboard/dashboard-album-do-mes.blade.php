    ...
    <script>
        $(document).ready(function() {
            ...
            */
            ...
            /**
             * Check if user has reached max number of photos already.
             * If yes, disables the fileuploader.
             */
            var api = $.fileuploader.getInstance($('#album-photos-input'));
            @if (count($files) == Auth::user()->subscription->plan->number_of_photos)
                api.disable();
            @endif
