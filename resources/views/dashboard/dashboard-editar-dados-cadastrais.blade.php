...
@section('dashboard-content')
            ...
            <div class="row mt-3">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" id="cpf" name="cpf" class="form-control" placeholder="999.999.999-99" value="{{ Auth::user()->cpf }}">
                    </div>
                </div>
            </div>
    ...
    <a href="#!" class="btn btn-info mt-5 btn-editar-dados">Salvar</a>
